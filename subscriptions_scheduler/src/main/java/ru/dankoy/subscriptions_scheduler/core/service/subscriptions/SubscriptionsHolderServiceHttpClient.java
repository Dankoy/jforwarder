...
@Service("subscriptionsHolderServiceHttpClient")
@RequiredArgsConstructor
public class SubscriptionsHolderServiceHttpClient implements SubscriptionsHolderService {

  private final SubscriptionsHolderHttpService subscriptionsHolderFeign;
