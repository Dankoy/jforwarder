...
public class KafkaTwoTopicsOneFactoryConfig {
  ...
  @Bean
  public ProducerFactory<String, CoubMessage> producerFactory(KafkaProperties kafkaProperties) {
    ...
    kafkaProducerFactory.setValueSerializer(new JacksonJsonSerializer<CoubMessage>());
