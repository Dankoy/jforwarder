...
public class SchedulerChannelSubscriptionService
    ...
    public SchedulerChannelSubscriptionService(ChannelSubscriptionService channelSubscriptionService,
    ...
    public void findLastPermalinkSubs(Page<ChannelSubscription> page) {
        ...
        for (var subscription : page) {
            ...
            List<Coub> coubsToSend = coubFinderService.findUnsentCoubsForChannelSubscription(subscription);
