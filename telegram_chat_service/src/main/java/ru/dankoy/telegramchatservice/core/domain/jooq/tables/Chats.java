...
public class Chats extends TableImpl<ChatsRecord> {
  ...
  public final TableField<ChatsRecord, String> TYPE =
      createField(DSL.name("type"), SQLDataType.VARCHAR(50), this, "");

  /** The column <code>public.chats.title</code>. */
  public final TableField<ChatsRecord, String> TITLE =
      createField(DSL.name("title"), SQLDataType.VARCHAR(80), this, "");

  /** The column <code>public.chats.first_name</code>. */
  public final TableField<ChatsRecord, String> FIRST_NAME =
      createField(DSL.name("first_name"), SQLDataType.VARCHAR(50), this, "");

  /** The column <code>public.chats.last_name</code>. */
  public final TableField<ChatsRecord, String> LAST_NAME =
      createField(DSL.name("last_name"), SQLDataType.VARCHAR(50), this, "");

  /** The column <code>public.chats.username</code>. */
  public final TableField<ChatsRecord, String> USERNAME =
      createField(DSL.name("username"), SQLDataType.VARCHAR(50), this, "");

  /** The column <code>public.chats.active</code>. */
  public final TableField<ChatsRecord, Boolean> ACTIVE =
      createField(DSL.name("active"), SQLDataType.BOOLEAN.nullable(false), this, "");

  /** The column <code>public.chats.message_thread_id</code>. */
  public final TableField<ChatsRecord, Integer> MESSAGE_THREAD_ID =
      createField(DSL.name("message_thread_id"), SQLDataType.INTEGER, this, "");

  /** The column <code>public.chats.date_created</code>. */
  public final TableField<ChatsRecord, LocalDateTime> DATE_CREATED =
      createField(DSL.name("date_created"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

  /** The column <code>public.chats.date_modified</code>. */
  public final TableField<ChatsRecord, LocalDateTime> DATE_MODIFIED =
      createField(DSL.name("date_modified"), SQLDataType.LOCALDATETIME(6), this, "");
